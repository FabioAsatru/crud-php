        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="<?php echo BASEURL; ?>professores">Gerenciar Professores</a></li>
                    <li><a href="<?php echo BASEURL; ?>porfessores/add.php">Novo Professor</a></li>
                </ul>
            </li>
            <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                ...
                <ul class="dropdown-menu">
                    <li><a href="<?php echo BASEURL; ?>cursos">Genrenciar Cursos</a></li>
                </ul>
            </li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                    <li><a href="<?php echo BASEURL; ?>notas">Lançar Notas</a></li>
                </ul>
            </li>
          </ul>
        </div><!--/.navbar-collapse -->
