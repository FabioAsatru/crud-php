...
<?php foreach ($cursos as $curso) : ?>
	<tr>
		...
		<td class="actions text-right">
			<a href="view.php?id=<?php echo $curso['id_curso']; ?>" class="btn btn-sm btn-success"><i class="fa fa-eye"></i> Visualizar</a>
			<a href="edit.php?id=<?php echo $curso['id_curso']; ?>" class="btn btn-sm btn-warning"><i class="fa fa-pencil"></i> Editar</a>
