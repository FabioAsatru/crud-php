...
<form action="add.php" method="post">
  ...
  <div class="row">
    ...
    <select class="form-control" name="nota['id_aluno']">
    <?php if ($alunos) : ?>
    ...
    <select class="form-control" name="nota['id_curso']">
    <?php if ($cursos) : ?>
    ...
    <select class="form-control" name="nota['id_professor']">
    <?php if ($professores) : ?>
  ...
  <div class="row">
    <div class="form-group col-md-2">
      ...
      <input type="text" id="nome" class="form-control" name="nota['nota1']">
    </div>

    <div class="form-group col-md-2">
      <label for="name">nota 2</label>
      <input type="text" id="notas" class="form-control" name="nota['nota2']">
    </div>

    <div class="form-group col-md-2">
      <label for="name">nota 3</label>
      <input type="text" id="curso" class="form-control" name="nota['nota3']">
    </div>

    <div class="form-group col-md-2">
      <label for="name">nota 4</label>
      <input type="text" id="curso" class="form-control" name="nota['nota4']">
    </div>
